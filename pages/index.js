  ...
  return ( 
    <div>
      ...
      <div className="Not">
        ...
        <ul>
          <li>
            <a className="link" href="https://www.healthline.com/health/anxiety">Information about Anxiety</a>
          </li>
          <li>
            <a className="link" href="https://www.healthline.com/health/mental-health/talk-therapy">Therapy Information</a>
          </li>
        </ul>
      </div>
    </div>
